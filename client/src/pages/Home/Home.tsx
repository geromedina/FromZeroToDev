    ...
    <body className="bg-gray-800">
      <section className="container mx-auto py-24 px-8">
        <div className="text-center lg:w-3/5 mx-auto mb-24">
          <h1 className="text-3xl lg:text-5xl font-medium text-white mb-2.5">
            The best platform to boost your tech career
          </h1>
          <p className="text-lg text-gray-400 mb-7">
            We have the largest community of experts to provide you with the
            ideal content for your learning
          </p>
          <div className="flex flex-col sm:flex-row justify-center">
            <NavLink to="/courses">
              <button
                type="button"
                className="mb-20 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2"
              >
                Start now
              </button>
            </NavLink>
          ...
          <div className="grid xl:grid-cols-2">
            <div className="bg-white p-8  sm:p-20 rounded-l-3xl rounded-r-3xl xl:rounded-r-none">
              <p className="text-lg text-gray-400 mb-10">
                "The FromZeroToDev courses have been incredible, I have been
                able to learn at my own pace and acquire the knowledge I need
                for my job."
              </p>
            ...
            <div className="testimonial rounded-r-3xl"></div>
          </div>
        </div>
      </section>
          ...
          <div className="container mx-auto px-8">
            <div className="grid lg:grid-cols-2">
              <div className="flex items-center lg:my-24 my-14">
                <div>
                  <h2 className="text-3xl lg:text-5xl font-bold text-white mb-2.5">
                    Create your own professional course now
                  </h2>
                  <p className="text-lg text-gray-400 mb-5">
                    Hundreds of the best courses were powered by our creators
                  </p>
