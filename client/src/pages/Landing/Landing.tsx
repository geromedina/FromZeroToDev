  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex flex-row">
        <div className="p-10">
          <img
            src="https://img.plasmic.app/img-optimizer/v1/img/5fc8c319beca87bfc95d188be8d58260.png?q=75&f=webp"
            alt=""
          />
        </div>
        <div className="flex flex-col text-center justify-center">
          <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-black md:text-5xl lg:text-6xl">
            ...
            the course platform that adapts to you.
          </h1>
          <p className="font-bold mb-3 text-gray-900 dark:text-gray-800 py-6">
            Specialize in development regardless of your level of knowledge and
