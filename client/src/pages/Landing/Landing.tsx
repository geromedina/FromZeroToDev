      ...
      <nav className="bg-white dark:bg-gray-900">
        ...
        <div className='flex flex-row'>
          ...
          <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-black md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-blue-500">FromZeroToDev </span>the course platform that adapts to you.</h1>
            ...
            <NavLink to="/home">
              <button type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Have a look</button>
            </NavLink>
          </div>
        </div>
         <Footer/>
